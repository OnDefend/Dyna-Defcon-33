...
class ConsentAnalyzer:
    """Plugin for consent analyzer analysis."""
    
    def __init__(self, config: Dict[str, Any] = None):
        self.config = config or {}
        self.plugin_name = "consent_analyzer"
        self.version = "1.0.0"
        self.description = "Consent Analyzer analysis for MASVS compliance"
        
    def run(self, apk_ctx, config=None) -> Tuple[str, Any]:
        """Run the consent_analyzer analysis."""
        try:
...
def get_plugin():
    """Get plugin instance."""
    return ConsentAnalyzer()

# Plugin metadata
PLUGIN_METADATA = {
    "name": "Consent Analyzer",
    "description": "User consent analysis for MASVS privacy requirements",
    "version": "1.0.0",
